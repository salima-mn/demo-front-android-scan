...
export class TopbarComponent implements OnInit, AfterViewInit {
  ...
  constructor(private layout: LayoutService, private auth: AuthService, private userService: UserService) {
    ...
    console.log("completeName : ",this.completeName)
      /*this.user$= this.userService.user;
      console.log("use : ",this.user$);
      this.completeName = this.userService.completeName;
      console.log("complete name : ",this.completeName)*/
  }
