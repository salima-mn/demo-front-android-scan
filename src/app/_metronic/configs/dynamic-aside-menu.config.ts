  ...
  items: [
    ...
    { section: 'Cette Application' },
    {
      ...
      submenu: [
        {
          title: 'Utilisateurs',
          page: '/this-config/users'
        },
        {
          title: 'Serveur Mail',
          page: '/this-config/mail-server'
        },
      ]
    },
    { section: 'Application Android' },
    {
      ...
      submenu: [
        {
          title: 'Utilisateurs',
          page: '/android-config/imeis'
        },
        {
          title: 'Générer Tokens',
          bullet: 'dot',
          page: '/android-config/token',
          icon: 'flaticon2-architecture-and-city',
        },
      ]
    },
    {
      title: 'Comparaison des fichiers',
      bullet: 'dot',
      root: true,
      page: '/compare-file',
      icon: 'flaticon2-architecture-and-city',
